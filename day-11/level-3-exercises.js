...
function convertArrayToObject(obj){
    ...
    for (const [name, skills, scores] of obj){
      let studentObj = ({name: name, skills: skills, scores: scores});
...
/* 4. Copie el objeto estudiante a newStudent sin mutar el objeto original. En el nuevo objeto añade lo siguiente:
  i. Añadir Bootstrap con el nivel 8 a los conjuntos de habilidades de front end
  ii. Añadir Express con nivel 9 a los conjuntos de habilidades del back end
  iii. Añadir SQL con nivel 8 a los conjuntos de habilidades de la base de datos
  iv. Añadir SQL sin nivel a los conjuntos de habilidades de ciencia de datos */
const student2 = {
  name: "David",
  age: 25,
  skills: {
...
const newStudent = deepCopy(student2);

const newElementFrontEnd = {skill: "Bootstrap", level: 8};
const newElementBackEnd = {skill: "Express", level: 9};
const newElementDataBase = {skill: "SQL", level: 8};
const newElementDataScience = "SQL";

newStudent.skills.frontEnd.push(newElementFrontEnd);
newStudent.skills.backEnd.push(newElementBackEnd);
newStudent.skills.dataBase.push(newElementDataBase);
newStudent.skills.dataScience.push(newElementDataScience);
